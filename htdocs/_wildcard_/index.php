...
<html lang="en">
	<head>
		...
		<link rel="icon" type="image/png" href="/shortcut-icon.png">
		...
		<meta property="og:image" content="https://<?php echo $_SERVER['HTTP_HOST'] ?>/h.gif">
		<meta name="twitter:image" content="https://<?php echo $_SERVER['HTTP_HOST'] ?>/h.gif">
