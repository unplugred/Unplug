...
include $_SERVER['DOCUMENT_ROOT'].'/assets/header.php'; ?>
		<style>
			...
			#utah {
				width: 243px;
				height: 209px;
				background-image: url("/assets/unplug/teapot.png?v=2");
...
also i have a <a href="https://twitter.com/unplugred/">twitter</a>
		...
		<script type="text/javascript">
			...
			var bg = loader.load("/assets/unplug/checkers.png");
			...
			document.onmousemove = function(e){
				if(scene.children.length == 1)
				{
					...
					teapot.rotation.x = (e.pageY - offset.top - 90)*.001;
					teapot.rotation.y = (e.pageX - offset.left - 116.5)*.001;
				}
			}
